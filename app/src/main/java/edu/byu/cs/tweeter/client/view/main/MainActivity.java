...
public class MainActivity extends AppCompatActivity implements StatusDialogFragment.Observer, MainPresenter.MainView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        followButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                presenter.followTask(followButton.getText().toString(), v, selectedUser);
            }
        });
    }
    ...
    public List<String> parseURLs(String post) {
        return presenter.parseURLs(post);
    }

    public List<String> parseMentions(String post) {
        return presenter.parseMentions(post);
    }

    public int findUrlEndIndex(String word) {
        return presenter.findUrlEndIndex(word);
    ...
    @Override
    public void setFollowButtonEnabled() {
        followButton.setEnabled(true);
    }

    @Override
    public void updateSelectedUsers(boolean buttonUpdate) {
        updateSelectedUserFollowingAndFollowers();
        updateFollowButton(buttonUpdate);
    }
    ...
    @Override
    public void logoutUserCancelToast() {
        logOutToast.cancel();
        logoutUser();
    }
