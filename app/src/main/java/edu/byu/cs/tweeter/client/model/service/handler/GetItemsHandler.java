...
public class GetItemsHandler <T> extends BackgroundTaskHandler<PagesObserver<T>> {

    public GetItemsHandler(PagesObserver<T> observer) {
        super(observer);
    }

    @Override
    protected void handleSuccess(Bundle data, PagesObserver<T> observer) {
